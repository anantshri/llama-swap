...
# The web UI under proxy/ui_dist/ is hand-authored static HTML/CSS/JS, committed
# to the repo. There is no JS build step; the Go binary embeds it via //go:embed.
